...
# save model
joblib.dump(best_pipeline, f'../model/best_pipeline_rf.clf')

# best classifier
best_classifier = best_pipeline.named_steps['classification']

# save model
joblib.dump(best_classifier, f'../model/best_classifier_rf.clf')

# save csv
csv_data = pd.DataFrame({'Model': ['Random forest'], 'mean test score': mean_test_score, 'SD test score': std_test_score})
